...
function AnimeList({animes, handleSelectedAnime, setSelectedAnime}){
  return (
...
export default function App() {
  ...
  return (
    <>
      ...
      <Main>
        <Box>
          <AnimeList animes={animes} handleSelectedAnime={handleSelectedAnime} setSelectedAnime={setSelectedAnime}/>
        </Box>
        <Box>
